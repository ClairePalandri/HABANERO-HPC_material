...
How to use Habanero? This page contains 4 resources to get started:

An overview of the main steps to interact with Habanero
A stand-alone tutorial showing how to run a simple .R script from A to Z on the cluster
Cheatsheets
